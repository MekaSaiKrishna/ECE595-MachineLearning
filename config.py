...
datasets = {
    ...
    'bsd300': dnnlib.EasyDict(dataset_dir='/content/drive/MyDrive/BSDS300/images/test'),
...
#    noise=poisson_noise_config,
    ...
    train_tfrecords='/content/drive/MyDrive/BSDS300/bsd300_train.tfrecords',
    ...
    def train(args):
        if args:
            ...
            if 'long_train' in args and args.long_train:
                ...
                train_config.iteration_count = 15000
